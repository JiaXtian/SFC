...
const controlCenterUrl = process.env.VITE_CONTROL_CENTER_URL || 'http://localhost:3002'
...
export default defineConfig({
  ...
  define: {
    __SFC_APP_TARGET__: JSON.stringify('main'),
    'import.meta.env.VITE_CONTROL_CENTER_URL': JSON.stringify(controlCenterUrl),
  },
  server: {
    host: '0.0.0.0',
    port: 3001,
