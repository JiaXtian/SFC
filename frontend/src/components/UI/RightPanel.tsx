...
export default function RightPanel({ mode = 'full' }: { mode?: 'full' | 'deployOnly' }) {
  ...
  return (
    ...
    >
      ...
      {!collapsed && (
        <div className="w-full min-w-0 flex flex-col overflow-hidden" style={{ background: 'transparent', borderTop: '1px solid rgba(87, 126, 160, 0.24)', borderLeft: '1px solid rgba(87, 126, 160, 0.24)', borderBottom: '1px solid rgba(87, 126, 160, 0.24)', backdropFilter: 'blur(16px)' }}>
