...
import SystemMessagePanel from './components/UI/SystemMessagePanel'
...
export default function App() {
  ...
  const qualityConfig = useMemo(() => {
    const ultraScale = satCount >= 5000
      ...
      {route === 'main' && (
        <>
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 11 }}>
            <div className="pointer-events-auto"><RightPanel mode="deployOnly" /></div>
            {candidateResult && (
              <Suspense fallback={null}>
